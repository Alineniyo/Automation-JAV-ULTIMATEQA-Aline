...
public class TS_Navigation_Exploritory_JUnit {
    ...
    public TS_Navigation_Exploritory_JUnit() {
        // Default constructor
    }
    ...
    /**
     * Test Case (TC) for Exlpore navigation
     */
    @RepeatedTest(1)
    @Tag("simple")
    @DisplayName("TC - Explore navigation")
    public void tc_explore_navigation() {
        FW_CustomAssertJU.autoPass(po_Home.navigateTo("https://ultimateqa.com/"));
        FW_CustomAssertJU.autoPass(po_Home.validateHomePage());
        FW_CustomAssertJU.autoPass(po_Home.clickServiceLink());
        FW_CustomAssertJU.autoPass(po_Service.validateServicePage());
        FW_CustomAssertJU.autoPass(po_Home.clickAboutLink());
        FW_CustomAssertJU.autoPass(po_About.validateAboutPage());
        FW_CustomAssertJU.autoPass(po_Home.clickBlogLink());
        FW_CustomAssertJU.autoPass(po_Blog.validateBlogPage());
        FW_CustomAssertJU.autoPass(po_Home.clickEducationLink());
        FW_CustomAssertJU.autoPass(po_Home.clickFreeCourseLink());
        // FW_CustomAssertJU.autoPass(po_FreeCourse.validateFreeCoursePage());
    }
